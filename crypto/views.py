...
SUPPORTED_COINS = {
    # Coins with a direct NGN market on Quidax
    'BTC':   'btcngn',
    'ETH':   'ethngn',
    'USDT':  'usdtngn',
    'XRP':   'xrpngn',
...
COIN_META = {
    ...
    'FTM':      {'name': 'Fantom',             'color': '#1969FF', 'letter': 'F'},
    ...
    'CNHC':     {'name': 'CNHC Token',         'color': '#DE2910', 'letter': 'C'},
    ...
    'COB':      {'name': 'Cobra King',         'color': '#4B5563', 'letter': 'C'},
    'VIRTUAL':  {'name': 'Virtual Protocol',   'color': '#0057FF', 'letter': 'V'},
    'LPT':      {'name': 'Livepeer',           'color': '#00EB88', 'letter': 'L'},
    ...
    'NAKA':     {'name': 'Nakamoto Games',     'color': '#4B5563', 'letter': 'N'},
    'ICP':      {'name': 'Internet Computer',  'color': '#29ABE2', 'letter': 'I'},
    'KAS':      {'name': 'Kaspa',              'color': '#70C7BA', 'letter': 'K'},
    'COQ':      {'name': 'Coq Inu',            'color': '#FF7A00', 'letter': 'C'},
    'JTO':      {'name': 'Jito',               'color': '#84CC16', 'letter': 'J'},
    'WASSIE':   {'name': 'Wassie',             'color': '#4B5563', 'letter': 'W'},
